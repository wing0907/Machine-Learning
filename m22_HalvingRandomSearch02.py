...
pd.DataFrame(model.cv_results_).sort_values(
                        'rank_test_score', # rank_test_score를 기준으로 오름차순 정렬
                        ascending=True).to_csv(path + 'm22_02_california_hgs_cv_results.csv')

path = './_save/m15_cv_results/'
joblib.dump(model.best_estimator_, path + 'm22_02_california_best_model.joblib')

# best_score (train CV r² 평균) : 0.3177210329255362
# model.score (test r²) : 0.8291799019140216
# MSE : 0.2176
# R² : 0.8292
# time : 15.2668 seconds