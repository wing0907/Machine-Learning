...
# best_score :  0.7782539682539682
# model.score :  0.7099236641221374
# best_acc_score :  0.7099236641221374
# accuracy_score :  0.7099236641221374
# time :  136.6979 seconds
...
pd.DataFrame(model.cv_results_).sort_values(
                        'rank_test_score', # rank_test_score를 기준으로 오름차순 정렬
                        ascending=True).to_csv(path + 'm20_07_dacon_당뇨병_hgs_cv_results.csv')

path = './_save/m15_cv_results/'
joblib.dump(model.best_estimator_, path + 'm20_07_dacon_당뇨병_best_model.joblib')
