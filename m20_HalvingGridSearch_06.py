...
# best_score :  0.9444444444444443
# model.score :  0.9824561403508771
# best_acc_score :  0.9824561403508771
# accuracy_score :  0.9824561403508771
# time :  108.2975 seconds
...
pd.DataFrame(model.cv_results_).sort_values(
                        'rank_test_score', # rank_test_score를 기준으로 오름차순 정렬
                        ascending=True).to_csv(path + 'm20_06_cancer_hgs_cv_results.csv')

path = './_save/m15_cv_results/'
joblib.dump(model.best_estimator_, path + 'm20_06_cancer_best_model.joblib')
