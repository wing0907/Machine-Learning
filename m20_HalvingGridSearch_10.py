...
pd.DataFrame(model.cv_results_).sort_values(
                        'rank_test_score', # rank_test_score를 기준으로 오름차순 정렬
                        ascending=True).to_csv(path + 'm20_10_fetch_covtype_hgs_cv_results.csv')

path = './_save/m15_cv_results/'
joblib.dump(model.best_estimator_, path + 'm20_10_fetch_covtype_best_model.joblib')

# best_score :  0.9676637886576203
# model.score :  0.9705687460736814
# best_acc_score :  0.9705687460736814
# accuracy_score :  0.9705687460736814