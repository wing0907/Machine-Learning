...
# 0.950 이상을 만족하는 주성분 개수: 43개
# 0.990 이상을 만족하는 주성분 개수: 49개
# 0.999 이상을 만족하는 주성분 개수: 51개
# 1.000 이상을 만족하는 주성분 개수: 52개

# exit()
# 2. PCA 차원 수 리스트
num_components_list = [43, 49, 51, 52, 54]
