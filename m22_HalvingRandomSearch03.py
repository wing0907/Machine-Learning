...
pd.DataFrame(model.cv_results_).sort_values(
                        'rank_test_score', # rank_test_score를 기준으로 오름차순 정렬
                        ascending=True).to_csv(path + 'm22_03_diabetes_hgs_cv_results.csv')

path = './_save/m15_cv_results/'
joblib.dump(model.best_estimator_, path + 'm22_03_diabetes_best_model.joblib')

# best_score (train CV r² 평균) : 0.1408214807510376
# model.score (test r²) : 0.13653939962387085
# MSE : 0.2092
# R² : 0.1365
# time : 15.0958 seconds