...
for i, fi in enumerate(model.feature_importances_): # index 와 값(fi)
    ...
    if fi <= percentile:        # 값이 낮은 놈을 찾아
        ...
        continue
print(col_name)         # ['pixel_0_0', 'pixel_0_4', 'pixel_1_0', 'pixel_1_7', 'pixel_2_0', 'pixel_2_6', 'pixel_2_7', 'pixel_3_0', 'pixel_3_7', 'pixel_4_0', 'pixel_4_7', 'pixel_5_0', 'pixel_5_7', 'pixel_6_0', 'pixel_6_7', 'pixel_7_0']
...
print('acc :', model.score(x_test, y_test))         # acc : 0.08611111111111111
