...
for i, fi in enumerate(model.feature_importances_): # index 와 값(fi)
    ...
    if fi <= percentile:        # 값이 낮은 놈을 찾아
        ...
        continue
print(col_name)         # ['pixel_0_0', 'pixel_0_4', 'pixel_1_0', 'pixel_1_7', 'pixel_2_0', 'pixel_2_6', 'pixel_2_7', 'pixel_3_0', 'pixel_3_7', 'pixel_4_0', 'pixel_4_7', 'pixel_5_0', 'pixel_5_7', 'pixel_6_0', 'pixel_6_7', 'pixel_7_0']   얘네를 PCA로 압축해서 붙여버리겠드아!

# exit()

x_f = pd.DataFrame(x, columns=datasets.feature_names) # 얘는 위에서 만들었어도 된다
x1 = x_f.drop(columns=col_name)                        # 고놈을 삭제해.
x2 = x_f[['pixel_0_0', 'pixel_0_4', 'pixel_1_0', 'pixel_1_7', 'pixel_2_0', 'pixel_2_6', 'pixel_2_7', 'pixel_3_0', 'pixel_3_7', 'pixel_4_0', 'pixel_4_7', 'pixel_5_0', 'pixel_5_7', 'pixel_6_0', 'pixel_6_7', 'pixel_7_0']]
print(x2)
...
model.fit(x_train, y_train)                                   # acc :  0.975
print('FI_Drop + PCA :', model.score(x_test, y_test))         # FI_Drop : 0.08611111111111111
                                                              # FI_Drop + PCA : 0.975
