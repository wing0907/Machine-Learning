...
dataset = load_boston() # x_train만 받겠다는 것. _ 는 자리표시
x = dataset.data
y = dataset.target      
...
# 0.990 이상을 만족하는 주성분 개수: 12개
# 0.999 이상을 만족하는 주성분 개수: 13개
# 1.000 이상을 만족하는 주성분 개수: 13개

# 2. PCA 차원 수 리스트
num_components_list = [8, 12, 13]
